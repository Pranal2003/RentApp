...
.btn-dark-yellow:focus {
    background-color: #FFDA00; /* Lighter shade of yellow on hover or focus */
    border-color: #FFDA00;
    color: #333;
}
.table-header {
				 ...
				 <div class="table-responsive">
				   ...
				   <%
						...
						Connection con = DBConnection.connect();
				   		...
				   		String query = "select * from confermorder where aid = ?";
				   ...
				   <% while(rs.next()){ 
					...
					<td><%= rs.getFloat(10) %></td>  
					  ...
					  <td><a href="vieworder.jsp?id=<%= rs.getInt(1) %>" class="btn btn-dark-yellow btn-sm">View</a></td>
				   </tr>
				   <% } %>
