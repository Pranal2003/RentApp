...
<div class="inner-block">
    <div class="product-block">
    	...
    	<%        
          ...
          String query ="SELECT equipment.eimage, equipment.eid, equipment.ename, equipment.ehourprice,equipment.edayprice, admin.aname, equipment.eavailable, admin.latitude, admin.longitude  FROM equipment JOIN admin ON equipment.aid = admin.aid where equipment.ecategary=? ";
        ...
        <div class="col-md-4 product-grid">
    		<div class="product-items">
	    		    <div class="project-eff">
						<div id="nivo-lightbox-demo"> <p> <a href="data:image/jpeg;base64, <%= base64Image %>"data-lightbox-gallery="gallery1" id="nivo-lightbox-demo"><span class="rollover1"> </span> </a></p></div>     
							<img class="img-responsive" src="data:image/jpeg;base64, <%= base64Image %>" alt="">
					</div>
	    		<div class="produ-cost">
                    <h3><%= rs.getString(3) %></h3>
                    <h4 style="color: black;">Hour price: <%=rs.getFloat(4)  %></h4>
                    <h4 style="color: black;">Day price: <%= rs.getFloat(5) %> </h4>
                    <h4 style="color: black;">Owner: <%= rs.getString(6) %></h4>
                    <h4 style="color: black;">Distance: <%= dis %> km</h4>
	    			<h4 style="color: black;">Status: <%=rs.getString(7) %></h4>
                   <a href="viewequipment.jsp?id=<%= rs.getInt(2) %>&dis=<%= dis %>"><button class="btn btn-default">view</button></a> 
	    		</div>
    		</div>
    	</div>
      <% } %>
