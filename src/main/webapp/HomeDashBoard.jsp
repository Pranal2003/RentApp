...
<link rel="icon" href="https://png.pngtree.com/png-vector/20220127/ourmid/pngtree-delivery-car-with-order-on-mobile-vector-illustration-png-image_4369176.png" type="image/x-icon" style="border-radius: 50%;">
     <title>
    SmartMove Rent-a-Ride
    </title>
...
SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design"
  ...
  <body class="cbp-spmenu-push">
    <div class="main-content">
        ...
        <div class="navbar-collapse">
          ...
          >
            <ul class="nav" id="side-menu">
              ...
              <li>
                <a href="#"
                  > <i class="fa-solid fa-person-walking"></i>&nbsp;Our Services
                  <span class="nav-badge">12</span>
                  <span class="fa arrow"></span
                ></a>
                <ul class="nav nav-second-level collapse">
                  <li>
                    <a href="#"><i class="fa-solid fa-wrench"></i>&nbsp;Rental Services</a>
                  </li>
              ...
              <li>
                ...
                <ul class="nav nav-second-level collapse">
                  <li>
                    <a href="index.jsp"><i class="fa-solid fa-user-tie"></i> Seller</a>
                  </li>
                  <li>
                    <a href="company.jsp"><i class="fa-solid fa-car"></i> Company</a>
                  </li>
                  <li>
                    <a href="usermap.html"><i class="fa-solid fa-user-plus"></i> User</a>
                  </li>
                </ul>
                <!-- //nav-second-level -->
              </li>
        ...
        <div class="header-left">
          ...
          <div class="logo">
            <a href="index">
              ...
              <h1><i class="fa-solid fa-car"></i> &nbsp;"SmartMove Rent-a-Ride"




 </h1>
              <p style="color:white;">Your Business, Our Expertise</p>
            </a>
          </div>
          <!--//logo-->
          <!--search-box-->
              ...
              <li class="dropdown head-dpdn">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="task-info">
                        <span class="task-desc">8 Service Providers Approve</span
              ...
              <li class="dropdown profile_details_drop">
                ...
                >
                  <div class="profile_img">
                   ...
                   <p>  <img src="./resources/images/MyImage1.JPG" alt="" style="width: 40px; height: 40px; border-radius: 50%;" class="profile_img"/>&nbsp; Prasannajeet Jain</p>
        ...
        <h1 style="color: #333;  padding: 20px; border-radius: 10px;">Our Services</h1>
				...
				<div
					...
					<img src="./resources/images/home.png" alt=""
						style="max-width: 48%; max-height: 600px; border-radius: 20px;">
					<img src="./resources/images/home2.png" alt=""
						style="max-width: 48%; max-height: 600px; border-radius: 20px;">
				</div>
				<br><br><br>
		 <img src="https://ic.maxabout.us//misc/infographics/car-infographics//Top-10-Best-Selling-Cars-in-India-Jan-2023.jpg"  alt="" style="max-width:100%; max-height: 100%; border-radius: 20px;">
          <br><br><br>
          
          
          		<img src="https://www.financialexpress.com/wp-content/uploads/2020/01/about-us-banner-tata-trucks.jpg"  alt="" style="max-width:100%; max-height: 100%; border-radius: 20px;">
                 <br><br><br>
          
		<img src="https://cdni.autocarindia.com/utils/imageresizer.ashx?n=http://img.haymarketsac.in/autocarpro/5a1ecce0-c2e0-4daa-8fc7-ffa0c83237e8_MAIN-VISUAL.jpg&w=750&h=490&q=75&c=1"  alt="" style="max-width:100%; max-height: 100%; border-radius: 20px;">
         <br><br><br> <img src="https://cdni.autocarindia.com/utils/imageresizer.ashx?n=http://img.haymarketsac.in/autocarpro/e4b481ec-2ea3-4503-8279-6c64f14c9ce0.jpg&w=735&h=490&q=80" alt="" style="max-width:100%; max-height: 100%; border-radius: 20px;">
          <br><br><br><br> 
      ...
      <div class="footer">
        <p>
          &copy; 2024 All Rights Reserved | Design with <i class="fa fa-solid fa-heart" style="color: #f00505;"></i>by
         Jayesh Sonavane   </a>
        </p>
      </div>
      <!--//footer-->
