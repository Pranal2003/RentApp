...
<div class="inner-block">
 ...
 <a href="recommendations.jsp" style="text-decoration: none;">
  <button class="custom-button" style="background-color: #A3B6F9; /* Green */
    ...
    <ul>
        <% 
            // Retrieve recommended vehicles from the request attribute
            List<String> recommendedVehicles = (List<String>) request.getAttribute("recommendedVehicles");
            // Display recommended vehicles
            for (String vehicle : recommendedVehicles) {
    ...
    <div class="product-items">
        ...
        <div class="produ-cost">
            <h3 style="color: black;"><%= rs.getString(3) %></h3>
            ...
            <a href="viewequipment.jsp?id=<%= rs.getInt(2) %>&dis=<%= dis %>">
                <button class="btn btn-success" id="viewButton">View</button>
            </a>
        </div>
    </div>
</div>
