...
<div class="inner-block">
    <div class="product-block">
    	...
    	<option value="tractor">Car</option>
   		 <option value="favarani">Truck</option>
   		 <option value="cultivitar">Auto</option>
   		  <option value="tilar">Bike</option>
   		   <option value="Plug">Heavy Truck</option>
   		   <option value="harvester">Trolley</option>
   		   <option value="Trolley">MiniBus</option>
 		 </select>
        ...
        <div class="col-md-4 product-grid">
    		<div class="product-items">
	    		...
	    		<div class="produ-cost">
                    <h3><%=  row.getEname()%></h3>
                    <h4 style="color: black;">Hour price: <%=row.getHourprice()  %></h4>
                    <h4 style="color: black;">Day price: <%= row.getDayprice() %> </h4>
                    <h4 style="color: black;">Owner: <%= row.getAname() %></h4>
                    <h4 style="color: Red;">Distance: <%= row.getDistance()%> km</h4>
	    			<h4 style="color: black;">Status: <%=row.getStatus() %></h4>
