    ...
    <div class="product-block">
    	...
    	if(rs.next()){ 
    	 ...
    	 %>
	    		...
	    		<div class="produ-cost"  style="color: black;">
                    <h3><%= rs.getString(3) %></h3>
					<h4 style="color: black;">Owner: <%= rs.getString(4)%> </h4>
					<h4 style="color: black;">Contact: <%= rs.getString(5)%></h4>
					<h4 style="color: black;">Category: <%= rs.getString(6)%></h4>
                    <h4 style="color: black;">Hour price: <%= rs.getFloat(7)%></h4>
                    <h4 style="color: black;">Day price: <%= rs.getFloat(8)%></h4>
					<h4 style="color: black;">Diposte: <%= rs.getFloat(9)%></h4>
					<h4 style="color: black;">Location: <%= rs.getString(10)%>, <%= rs.getString(11)%></h4>
					<h4 style="color: black;">Distance: <%= dis %> km</h4>
					<h4 style="color: black;">Status: <%= rs.getString(12)%></h4>
					<h4 style="color: black;">Discription:<%= rs.getString(13)%> </h4>
