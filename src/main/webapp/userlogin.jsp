        ...
        <div class="login-main">
            ...
            <div class="login-block text-center">
                ...
                <form action="UserLogin" method="post">
                    ...
                    <a href="usermap.html"><button class="fa fa-map-marker btn btn-primary" type="button"> Update
                            Location</button></a>
                    <input type="hidden" name="latitude" value="<%=lat %>" placeholder="latitude" required="" readonly>
                    <input type="hidden" name="longitude" value="<%=lng %>" placeholder="longitude" required="" readonly>
                    <div class="forgot-top-grids">
                        <div class="clearfix"> </div>
                    </div>
                    <input type="submit" name="Sign In" value="Login">
                    <h3>Not a member?<a href="usersignup.jsp">Sign up now</a></h3>
                </form>
                <div class="forgot-top-grids">
